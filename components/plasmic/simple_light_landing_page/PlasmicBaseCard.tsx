...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: BAA4iH-QQ2rD/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__iSXm, {
          [sty.freeBox__long__iSXmBDd5C]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__sXr0M, {
            [sty.freeBox__long__sXr0MbDd5C]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__evic6)}
                role={"img"}
              />
            ),
