...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: QyiAQh0-KVz5/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__o89Z9)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__l3IDe)}>
          <div className={classNames(defaultcss.all, sty.freeBox__xdff5)}>
            {p.renderPlasmicSlot({
