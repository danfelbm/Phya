...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: WV2mNEE6oQ0/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__aNxBu, {
            [sty.freeBox__long__aNxBUvpjJd]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          <div
            className={classNames(defaultcss.all, sty.freeBox__z81Xf, {
              [sty.freeBox__long__z81XfvpjJd]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg___3SdWf)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__cK2Ue, {
          [sty.freeBox__long__cK2UevpjJd]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__awNmj, {
            [sty.freeBox__long__awNmjvpjJd]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg___2FqXr)}
                role={"img"}
              />
            ),
