...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: 87HcVyl97EM/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: qei3pNb6J7L9/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__xXtQ)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___9QpAl)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.freeBox__szXGx)}>
          <SphereIcon
