...
import BaseCard from "../../BaseCard"; // plasmic-import: BAA4iH-QQ2rD/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: dluXJX0C80Ra/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__r3VQr)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___105Uo)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__eKVbF)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet___4Cugw)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__hEh9L)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__oRzYn)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__mJkhg)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
