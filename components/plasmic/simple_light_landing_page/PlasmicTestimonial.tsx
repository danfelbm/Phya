...
import Avatar from "../../Avatar"; // plasmic-import: Hl5zYlzUjtSP/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: z-7llQ_dHz67/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: Zsw7lBtCPoTw/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__in73N)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__rc16N)}
        >
          <div
            className={classNames(
              defaultcss.all,
